...
"[project]/frontend/src/app/admin/dashboard/blogs/AdminBlogsPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$apis$2f$Blog$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/apis/Blog/api.ts [app-client] (ecmascript)");
;
...
const columns = [
    ...
    },
    {
        key: "image",
        label: "Image",
        render: (value)=>value ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                src: value.startsWith("/stored-files/") ? "".concat(BACKEND_URL.replace(/\/$/, "")).concat(value) : "".concat(BACKEND_URL.replace(/\/$/, ""), "/stored-files/blog-images/").concat(value),
                alt: "Blog",
                className: "h-10 w-16 object-cover rounded"
            }, void 0, false, {
                fileName: "[project]/frontend/src/app/admin/dashboard/blogs/AdminBlogsPage.tsx",
                lineNumber: 40,
                columnNumber: 9
...
function AdminBlogsPage() {
    ...
    const [editingBlog, setEditingBlog] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchBlogs = async ()=>{
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$apis$2f$Blog$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBlogs"])();
            console.log(res);
            setBlogs(res.data);
        } catch (error) {
    ...
    const filteredBlogs = blogs.filter((blog)=>blog.title.toLowerCase().includes(searchTerm.toLowerCase()) || blog.description.toLowerCase().includes(searchTerm.toLowerCase()) || blog.category.toLowerCase().includes(searchTerm.toLowerCase()));
    // Edit handler
    ...
    const handleDelete = async (blog)=>{
        if (confirm('Are you sure you want to delete "'.concat(blog.title, '"?'))) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$apis$2f$Blog$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteBlog"])(blog._id);
                fetchBlogs();
            } catch (error) {
    ...
    const handleSave = async (blogData)=>{
        try {
            ...
            if (editingBlog) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$apis$2f$Blog$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateBlog"])(editingBlog._id, formData);
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$apis$2f$Blog$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBlog"])(formData);
            }
            fetchBlogs();
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$Admin$2f$AdminModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BlogForm, {
                        blog: editingBlog,
                        onSave: handleSave,
                        onCancel: ()=>{
                            setIsModalOpen(false);
...
_s(AdminBlogsPage, "jjbVv1FndBGlSy03EEmUKJINNfE=");
_c = AdminBlogsPage;
/**
 * BlogForm component
 * Handles both create and update, supports image upload.
 */ function BlogForm(param) {
    let { blog, onSave, onCancel } = param;
    _s1();
    const [formData, setFormData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        ...
        category: (blog === null || blog === void 0 ? void 0 : blog.category) || "",
        image: (blog === null || blog === void 0 ? void 0 : blog.image) || "",
        imageFile: undefined
    });
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    formData.image && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                        src: formData.image.startsWith("blob:") ? formData.image : formData.image.startsWith("/stored-files/") ? "".concat(BACKEND_URL.replace(/\/$/, "")).concat(formData.image) : "".concat(BACKEND_URL.replace(/\/$/, ""), "/stored-files/blog-images/").concat(formData.image),
                        alt: "Preview",
...
_s1(BlogForm, "O/lDa4Fj8UacxN4HOJxR+rmAwiM=");
_c1 = BlogForm;
var _c, _c1;
__turbopack_context__.k.register(_c, "AdminBlogsPage");
__turbopack_context__.k.register(_c1, "BlogForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_910e2ecd._.js.map