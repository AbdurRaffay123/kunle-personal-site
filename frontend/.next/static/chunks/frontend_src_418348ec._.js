                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("time", {
                                ...
                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(blog.createdAt || blog.updatedAt, "short")
                            }, void 0, false, {
                                fileName: "[project]/frontend/src/components/Card/BlogCard.tsx",
                                lineNumber: 61,
                                columnNumber: 11
...
function BlogPage() {
        ...
        "BlogPage.useEffect": ()=>{
            const fetchBlogs = {
                "BlogPage.useEffect.fetchBlogs": async ()=>{
                    ...
                    setError(null);
                    try {
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$apis$2f$Blog$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBlogs"])(); // No page/limit
                        setBlogs(res.data || []);
                    } catch (err) {
                        setError((err === null || err === void 0 ? void 0 : err.message) || "Failed to fetch blogs");
                    }
                    setLoading(false);
                }
        ...
        "BlogPage.useMemo[filteredBlogs]": ()=>{
            ...
            return blogs.filter({
                "BlogPage.useMemo[filteredBlogs]": (blog)=>{
                    var _blog_description, _blog_tags;
                    return !searchTerm || blog.title.toLowerCase().includes(searchTerm.toLowerCase()) || ((_blog_description = blog.description) === null || _blog_description === void 0 ? void 0 : _blog_description.toLowerCase().includes(searchTerm.toLowerCase())) || ((_blog_tags = blog.tags) === null || _blog_tags === void 0 ? void 0 : _blog_tags.some({
                        "BlogPage.useMemo[filteredBlogs]": (tag)=>tag.toLowerCase().includes(searchTerm.toLowerCase())
                    }["BlogPage.useMemo[filteredBlogs]"]));
                }
            }["BlogPage.useMemo[filteredBlogs]"]);
        }
    ...
    const refetch = ()=>{
        setLoading(true);
        setError(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$apis$2f$Blog$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBlogs"])().then((res)=>setBlogs(res.data || [])).catch((err)=>setError((err === null || err === void 0 ? void 0 : err.message) || "Failed to fetch blogs")).finally(()=>setLoading(false));
    };
    if (error) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                !loading && filteredBlogs.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "grid gap-8 sm:grid-cols-2 lg:grid-cols-3",
                    children: filteredBlogs.map((blog, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BlogPage, "Sd1NaSe+LIgy3qblqdByJUHNvKA=");
_c = BlogPage;
var _c;
...
//# sourceMappingURL=frontend_src_418348ec._.js.map