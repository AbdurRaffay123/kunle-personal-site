  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-6 flex flex-col h-full transition hover:scale-[1.02] hover:shadow-lg">
      ...
      <a
        ...
        className="mt-auto inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/40 hover:text-blue-800 dark:hover:text-blue-300 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200"
      >
        View Research
      </a>
